// API functions for Student entity based on Swagger (OpenAPI)
...
const baseURL = `${API_BASE}/api/Students`;
...
export async function getStudentsPagination(params: Record<string, any> = {}) {
  try {
    const url = new URL(`${API_BASE}/api/Students/pagination`);
    ...
    console.log("Fetching students from URL:", url.toString());
    ...
    console.log("Raw students data received:", JSON.stringify(responseData, null, 2));
    ...
    console.error("Error in getStudentsPagination:", error);
    throw error;
  }
} 